      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-500 dark:text-gray-400 mb-1.5 transition-colors duration-300">Project Title</label>
              <input
                type="text"
                name="title"
        ...
        <div className="lg:col-span-8 grid md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#18181b] border border-slate-200 dark:border-white/10 p-6 rounded-2xl flex flex-col justify-between hover:border-slate-300 dark:hover:border-white/20 shadow-sm dark:shadow-none transition-colors duration-300 group"
            >
              <div>
