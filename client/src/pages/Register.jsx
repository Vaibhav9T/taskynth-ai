    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#09090b] flex items-center justify-center px-6 relative overflow-hidden transition-colors duration-300">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5 transition-colors duration-300">Full Name</label>
            <input
              type="text"
              name="name"
        ...
        <p className="text-center text-sm text-slate-500 dark:text-gray-400 mt-8 transition-colors duration-300">
          ...
          <Link to="/login" className="text-slate-900 dark:text-white font-medium hover:underline ml-1.5 transition-colors duration-300">
            Sign in
          </Link>
        </p>
      </motion.div>
